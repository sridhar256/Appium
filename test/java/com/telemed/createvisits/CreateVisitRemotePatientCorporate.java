...
public class CreateVisitRemotePatientCorporate extends ExtentReportManager {
	...
	public void setUp() throws InterruptedException, IOException {
		...
		tcData = CommonMethods.readDataFromTC("CreateVisitRemotePatientCorporate");
	}
	...
	public void loginPageTest() throws InterruptedException {
		...
		logger =extent.createTest("CreateVisitPage_TC_CVRPC_02"); 
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_02): Validate 'Email' textbox in login page.",ExtentColor.BLUE));
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_03");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_03): Validate 'Password' textbox in login page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_04");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_04): Verify LOG IN button in login page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_05");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_05): Verify Create Visit Icon in dashboard page.",ExtentColor.BLUE));	
		 ...
		 * 
		 * logger = extent.createTest("CreateVisitPage_TC_CVRPC_13");
		 * logger.log(Status.INFO,MarkupHelper.
		 * createLabel("TestCase(CreateVisitPage_TC_CVRPC_13): Verify 'Cancel' button in create visit page."
		 * ,ExtentColor.BLUE));
		 * 
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_14");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_14): Validate 'Visit Type' drop down in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_15");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_15): Validate 'Purpose of Visit' Type drop down in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_16");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_16): Validate 'Drug Type' drop down in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_18");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_18): Validate 'Branch' drop down in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_19");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_19): Validate 'State' drop down in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_20");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_20): Validate 'Social Security Number' textbox in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_21");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_21): Validate 'First Name' textbox in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_22");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_22): Validate 'Last Name' textbox in create visit page.",ExtentColor.BLUE));	

		if (lastName.isDisplayed()) { 
			logger.log(Status.PASS,MarkupHelper.createLabel("User is able to input 'RemotePatientCorporate' in 'Last Name' field in create visit page.",ExtentColor.GREEN));  

		} else {
			logger.log(Status.FAIL,MarkupHelper.createLabel("User is unable to input 'RemotePatientCorporate' in 'Last Name' field in create visit page.",ExtentColor.RED));  
		}
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_23");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_23): Validate 'Phone Number' textbox in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_24");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_24): Validate 'Additional E-Mail(s)' textbox in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_25");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_25): Validate 'Patient E-mail' textbox in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_26");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_26): Validate 'Date of Birth' textbox in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_27");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_27): Validate 'Date of Drug test' textbox in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_29");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_29): Verify Remote Patient radio buttons functionality for Yes option in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_30");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_30): Verify No button functionality in Info pop up (Are you sure that patient is 'Remote'. Do you wish to continue?).",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_31");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_31): Verify Yes button functionality in Info pop up (Are you sure that patient is 'Remote'. Do you wish to continue?).",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_32");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_32): Verify No button functionality in Info pop up (Is remote patient phone number available with you? ).",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_33");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_33): Verify Yes button functionality in Info pop up (Is remote patient phone number available with you? ).",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_34");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_34): Validate 'Phone Number' textbox in Remote Patient Info section in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_35");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_35): Verify 'Start New Visit' button in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_36");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_36): Verify 'No' button functionality in Document's info pop up in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_37");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_37): Verify 'Start New Visit' button in create visit page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_38");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_38): Verify 'Select a Provider' drop down in 'Select a Provider' page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_39");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_39): Verify OK button functionality in 'Select a Provider' page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_40");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_40): Verify End Call functionality.",ExtentColor.BLUE));	
		 ...
		 * );
		 * 
		 * logger = extent.createTest("CreateVisitPage_TC_CVRPC_41");
		 * logger.log(Status.INFO,MarkupHelper.
		 * createLabel("TestCase(CreateVisitPage_TC_CVRPC_41): Verify Notify Remote Patient button functionality."
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_42");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_42): Verify CANCEL button functionality in INFO pop up.",ExtentColor.BLUE));	
		 ...
		 * 
		 * logger = extent.createTest("CreateVisitPage_TC_CVRPC_43");
		 * logger.log(Status.INFO,MarkupHelper.
		 * createLabel("TestCase(CreateVisitPage_TC_CVRPC_43): Verify DELETE button functionality in INFO pop up."
		 * ,ExtentColor.BLUE));
		 * 
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_44");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_44): Verify Dashboard Menu in Dashboard page.",ExtentColor.BLUE));	
		...
		logger = extent.createTest("CreateVisitPage_TC_CVRPC_45");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(CreateVisitPage_TC_CVRPC_45): Verify Sign Out option in Menu Items.",ExtentColor.BLUE));	

...
public class CreateVisitNoRemotePatientMentalHealth extends ExtentReportManager {
	...
	public void setUp() throws InterruptedException, IOException {
		...
		tcData = CommonMethods.readDataFromTC("CreateVisitNoRemotePatientMentalHealth");
	}
	...
	public void loginPageTest() throws InterruptedException {
		...
		if (lastName.isDisplayed()) { 
			logger.log(Status.PASS,MarkupHelper.createLabel("User is able to input 'NoRemotePatientMentalHealth' in 'Last Name' field in create visit page.",ExtentColor.GREEN));  

		} else {
			logger.log(Status.FAIL,MarkupHelper.createLabel("User is unable to input 'NoRemotePatientMentalHealth' in 'Last Name' field in create visit page.",ExtentColor.RED));  
		}
